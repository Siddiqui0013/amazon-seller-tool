...
const BarChartLines = [{ dataKey: "uv", stroke: "#ff7300" }];
const BarChartBars = [{ dataKey: "pv", fill: "#413ea0", barSize: 20 }];
        ...
        <table className="w-full table-auto">
          <thead className="bg-gray-200">
            <tr>
              ...
              <th className="border border-gray-300 p-2">Current Stock Level</th>
            ...
            {reorderData.length > 0 ? (
              reorderData.map((item, index) => (
                <tr key={index} className="text-center hover:bg-gray-100">
                  ...
                  <td className="border px-4 py-2">{item.leadTime}</td>
